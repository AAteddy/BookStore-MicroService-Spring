...
public class RabbitMQConfig {
    ...
    RabbitMQConfig(ApplicationProperties properties) {
        ...
        System.out.println("RabbitMQConfig initialized with exchange: " + properties.orderEventsExchange());
    }
    ...
    Queue deliveredOrdersQueue() {
        return QueueBuilder
                .durable(properties.deliveredOrdersQueue())
                .build();
    }
    ...
    Queue cancelledOrdersQueue() {
        return QueueBuilder
                .durable(properties.cancelledOrdersQueue())
                .build();
    }
    ...
    Queue errorOrdersQueue() {
        return QueueBuilder
                .durable(properties.errorOrdersQueue())
                .build();
    }
