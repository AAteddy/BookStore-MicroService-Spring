package com.teddyHub.bookstore.orders.testdata;
...
import com.teddyHub.bookstore.orders.domain.models.Address;
import com.teddyHub.bookstore.orders.domain.models.CreateOrderRequest;
import com.teddyHub.bookstore.orders.domain.models.Customer;
import com.teddyHub.bookstore.orders.domain.models.OrderItem;
import org.instancio.Instancio;

public class TestDataFactory {
    static final List<String> VALID_COUNTRIES = List.of("Eritrea", "Germany");
